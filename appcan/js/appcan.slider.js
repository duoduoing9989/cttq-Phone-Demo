...
appcan.define("slider", function(a, b, c) {
    ...
    g.prototype = {
        ...
        set : function(b) {
            ...
            return c.option.hasLabel && (c.label = c.label || a('<div class="uinn1 ulev-1 ut-s slide-label-1 sc-text-hint"></div>'), c.ele.append(c.label)), c.focus = c.focus || a('<div class="utra focus"></div>'), c.focus.css("width", f), c.focus.css("-webkit-transform", "translateX(" + c.option.index * f + "px)"), c.ele.append(c.focus), c._moveTo(c.option.index, !1), c.ele.on("swipeMoveLeft", function(a) {
