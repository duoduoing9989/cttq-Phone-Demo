(function($, window) {
	...
	$.Zoom = function(element, options) {
		...
		zoom.onTouchstart = function(e) {
			e.preventDefault();
			imageIsTouched = true;
			// 在电脑浏览器上没有e.targetTouches导致报错, zhaohuihua, 2016-11-15
			// imageTouchesStart.x = e.type === $.EVENT_START ? e.targetTouches[0].pageX : e.pageX;
			imageTouchesStart.x = e.targetTouches && e.type === $.EVENT_START ? e.targetTouches[0].pageX : e.pageX;
			// imageTouchesStart.y = e.type === $.EVENT_START ? e.targetTouches[0].pageY : e.pageY;
			imageTouchesStart.y = e.targetTouches && e.type === $.EVENT_START ? e.targetTouches[0].pageY : e.pageY;
		};
		zoom.onTouchMove = function(e) {
			...
			imageTouchesCurrent.x = e.targetTouches && e.type === $.EVENT_MOVE ? e.targetTouches[0].pageX : e.pageX;
			// imageTouchesCurrent.y = e.type === $.EVENT_MOVE ? e.targetTouches[0].pageY : e.pageY;
			imageTouchesCurrent.y = e.targetTouches && e.type === $.EVENT_MOVE ? e.targetTouches[0].pageY : e.pageY;
		...
		zoom.onTouchEnd = function(e) {
			// 在电脑浏览器上没有e.touches导致报错, zhaohuihua, 2016-11-15
